        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm ">
              Discover the authentic flavors of India with our expertly crafted biryanis. Made with the finest ingredients and traditional recipes, each bite offers a rich and satisfying experience. Perfect for every palate, from mild to spicy.
              </p>
              <div>
